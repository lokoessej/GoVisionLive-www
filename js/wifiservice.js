angular.module('WifiServices', [])
	.factory('WifiService', function(){
		...
		// function connectWifiCamera(wifi_ssid,pass){
		// 	var wifiObject = WifiWizard.formatWPAConfig(wifi_ssid,pass);
		// 	WifiWizard.connectNetwork(wifiObject, win_wifi, fail_wifi);
		// }
		...
		return {
		  ...
		  connectionToWifi: function(name){
		  	connectWifi(name);
				...
				// connectWifiCamera(name,password);
		  }
		};
	});
